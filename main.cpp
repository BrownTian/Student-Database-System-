...
void enroll_right2018(string chosecourse ,string student_id);
void enroll_right2019(string chosecourse,string student_id);
...
void login()
{
    ...
    // release the memo space
    mysql_free_result(res_set);
}

/*determine how to decide the quarter.*/
...
{   string option;
    ...
    mysql_real_connect (conn,"localhost","root","Tbw519060432@","project3-nudb",3306,NULL,0);
    ...
    for (int i = 0; i < numrows; i++)
    {
        ...
        if(row != NULL)
        {
            ...
            cout << "| Quarter |: " << row[2] << endl;
        }
    }
    cout << "********************************"<<endl;
    
    cout << "Please Choose From the Following Option :" << endl;
    cout << "Enter 1 to Access Transcript" << endl;
    cout << "Enter 2 for Enroll Course" << endl;
    cout << "Enter 3 for Withdraw Course" << endl;
    cout << "Enter 4 to Access Personal Details" << endl;
...
{   string Transcript_option;
    ...
    cout << "*********************************"<< endl;
    cout << "*                               *" << endl;
    cout << "*   TRANSCRIPT:"+student_id+"          *"<< endl;
    cout << "*                               *" << endl;
    cout << "*********************************"<< endl;
    for (int i = 0; i < numrows; i++)
    {
    ...
    cout << "Please select one of the following option:" << endl << "Enter 1 for Details" << endl << "Enter 2 for Student Menu"<<endl;
    cout << "Your option is : " ;
...
{   string course_number;
    ...
    {
        row = mysql_fetch_row(res_set);
        //For the courses that have a grade
        if(row[7]!= NULL)
        {
            cout << "***********************************************" << endl;
            cout << "*                                             *" << endl;
            ...
            cout << "| MaxEmroll Numbers|:" << row[5] << endl;
            cout << "| Lecturer Name    |:" << row[6] << endl;
        ...
        else//For the courses that do not have a grade
        {
            cout << "************************************************" << endl;
            cout << "*                                              *" << endl;
            cout << "*               COURSE DETAILS :               *" << endl;
        ...
        cout << "*** Please enter a correct course number! ***" << endl;
        Details(student_id);
    }
    mysql_free_result( res_set );
}
...
void personaldetails(string student_id)
{
    ...
    cout << "***********************************"<<endl;
    cout << "Enter 1 to change the Password"<<endl<<"Enter 2 to change the Address"<<endl<<"Enter 3 to go back to student menu"<<endl;
    cout << "Your option is : ";
    string change;
    cin >> change;
    if(change == "1")
...
void enroll(string student_id)
{
    ...
    if ( (whichyear == int2str(year)) && (whichquarter == student_semester) )
    {
        ...
        cout << "Enter 3 back to student menu" <<endl;
        ...
        if ( enroll_or_not == "1" )
        {
            ...
            if ( numrows1 == 1)
            {
                ...
                enroll_right2018(chosecourse1,student_id);
            }
            
            else {
                cout << "***  Invalid command! You can not enroll this class, please go back to previous stage to check the pre-request of this course  ***" << endl;
    ...
    else if ( (whichyear == int2str(year1)) && (whichquarter == student_semester1) )
    {
        ...
        if ( enroll_or_not == "1" )
        {
            cout << "Please enter the course that you want to enroll" << endl;
            string chosecourse1;
            cin >> chosecourse1;
            ...
            if ( numrows1 == 1)
            {
                ...
                enroll_right2019(chosecourse1,student_id);
            }
            else
            {
                cout << "***       Invalid command!      ***" << endl;
...
void enroll_right2018 ( string chosecourse ,string student_id)
{
    ...
    cout << "***  Course enrolled uccessfully!  ***" << endl;
    cout << "***********************************" << endl;
    cout << "Enter 1 to go back to enroll menu" << endl;
    cout << "Enter 2 to go back to student menu" << endl;
    cout << "Your option is : ";
...
void withdraw(string student_id)
{
    ...
    if ( (whichyear == int2str(year)) && (whichquarter == student_semester) )
    {
        ...
        if ( numrows != 0 )
        {
            ...
            cout << "*                                 *" << endl;
            cout << "***********************************" << endl;
            cout << " Course that can be withdrawed : " << endl;
        ...
        {
            cout << "*** No course can be withdrawed! ***" << endl;
            cout << "*** Go back to student menu! ***" << endl << endl;
            student_menu(student_id);
        }
        ...
        string decide_drop;
        cout<<"Enter 0 back to student menu"<<endl;
        cout<<"Enter 1 continue drop a class"<<endl;
        cin>>decide_drop;
    ...
    else if ( (whichyear == int2str(year1)) && (whichquarter == student_semester1) )
    {
        ...
        if ( numrows2 != 0 )
        {
            ...
            cout << "*                                 *" << endl;
            cout << "***********************************" << endl;
            cout << " The courses that can be withdrawed : " << endl;
...
void withdraw_right ( string chosecourse ,string student_id,int year,string student_semester)
{
    ...
    cout << "*** Course withdraw successfully ***" << endl << endl;
    ...
    if(numrows10!=0)
    {cout << "*** Warning: Enrollment number goes below 50% of the MaxEnrollment! Your course is under risk of being cancelled ***" << endl<< endl;
...
int main ( int argc, char *argv[] )
{
    ...
    mysql_real_connect (conn,"localhost","root","Tbw519060432@","project3-nudb",3306,NULL,0);
    if(conn == NULL){
        printf("Please try to connect again.");
    }
    else{
        printf("Congraduations! You are now connected!");
    }
    cout << "" <<endl;
    cout << "************************************************************" << endl;
    cout << "*                                                          *" << endl;
    cout << "*   Welcome to Caesar system of Northwestern University!   *" << endl;
    cout << "*                                                          *" << endl;
    cout << "************************************************************" << endl;
    login();
}
